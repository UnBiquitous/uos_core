...
public class OntologyDriverImpl implements OntologyDriver {
	...
	@Override
	public void isInstanceOf(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
	...
	@Override
	public void isSubClassOf(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
	...
	@Override
	public void hasObjectProperty(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
		...
		if (instanceName1 != null && objectPropertyName != null && instanceName2 != null) {
			returned_object.put("queryResult",
					reasoner.hasObjectProperty(instanceName1, objectPropertyName, instanceName2));
		}
	...
	@Override
	public void getInstancesFromClass(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
		String className = (String) serviceCall.getParameter(CLASS_NAME_PARAM);
		...
		if (direct != null && className != null) {
			...
			returned_object.set("queryResult",
					mapper.valueToTree(reasoner.getInstancesFromClass(className, directValue)));
		}
	...
	@Override
	public void getSubClassesFromClass(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
		String className = (String) serviceCall.getParameter(CLASS_NAME_PARAM);
		String direct = (String) serviceCall.getParameter(DIRECT_PARAM);
		if (direct != null && className != null) {
			boolean directValue = Boolean.parseBoolean(direct);
			returned_object.set("queryResult",
					mapper.valueToTree(reasoner.getSubClassesFromClass(className, directValue)));
		}
	...
	@Override
	public void getSuperClassesFromClass(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
		String className = (String) serviceCall.getParameter(CLASS_NAME_PARAM);
		String direct = (String) serviceCall.getParameter(DIRECT_PARAM);
		if (direct != null && className != null) {
			boolean directValue = Boolean.parseBoolean(direct);
			returned_object.set("queryResult",
					mapper.valueToTree(reasoner.getSuperClassesFromClass(className, directValue)));
		}
	...
	@Override
	public void getDataPropertyValues(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
		...
		if (instanceName != null && dataPropertyName != null) {
			returned_object.set("queryResult",
					mapper.valueToTree(reasoner.getDataPropertyValues(instanceName, dataPropertyName)));
		}
	...
	@Override
	public void areDisjointClasses(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
	...
	@Override
	public void areEquivalentClasses(Call serviceCall, Response serviceResponse, CallContext messageContext) {
		ObjectNode returned_object = mapper.getNodeFactory().objectNode();
	...
	public UpDriver getDriver() {
		...
		driver.addService("isInstanceOf").addParameter("instanceName", UpService.ParameterType.MANDATORY)
				.addParameter("className", UpService.ParameterType.MANDATORY);
		driver.addService("isSubClassOf").addParameter("subClassName", UpService.ParameterType.MANDATORY)
				.addParameter("className", UpService.ParameterType.MANDATORY);
		driver.addService("hasObjectProperty").addParameter("instanceName1", UpService.ParameterType.MANDATORY)
				.addParameter("objectPropertyName", UpService.ParameterType.MANDATORY)
				.addParameter("instanceName2", UpService.ParameterType.MANDATORY);
		driver.addService("areDisjointClasses").addParameter("className1", UpService.ParameterType.MANDATORY)
				.addParameter("className2", UpService.ParameterType.MANDATORY);
		driver.addService("areEquivalentClasses").addParameter("className1", UpService.ParameterType.MANDATORY)
				.addParameter("className2", UpService.ParameterType.MANDATORY);
		return driver;
	}
	...
	public void init(Gateway gateway, InitialProperties properties, String instanceId) {
		...
		if (((SmartSpaceGateway) gateway).getOntology() != null) {
			this.ontologyInstance = (OntologyInstance) ((SmartSpaceGateway) gateway).getOntology()
					.getOntologyInstance();
	 ...
	 *
	 * @param messageType
	 *            Description of which type of action was taken (add or remove).
	 * @param className
	 *            class name.
	 * @param instanceName
	 *            instance name.
