...
public class RegisterDriverImpl implements RegisterDriver {
	...
	/** 
	 * @see br.unb.unbiquitous.ubiquitos.uos.driver.RegisterDriver#listDrivers(br.unb.unbiquitous.ubiquitos.uos.messageEngine.messages.ServiceCall, br.unb.unbiquitous.ubiquitos.uos.messageEngine.messages.ServiceResponse, br.unb.unbiquitous.ubiquitos.uos.context.UOSMessageContext)
	 */
	@Override
	...
	/**
	 * @see br.unb.unbiquitous.ubiquitos.uos.driverManager.UosDriver#getDriver()
	 */
	@Override
	...
	/** 
	 * @see br.unb.unbiquitous.ubiquitos.uos.driverManager.UosDriver#init(br.unb.unbiquitous.ubiquitos.uos.context.UOSApplicationContext)
	 */
	@Override
	...
	/**
	 * @see br.unb.unbiquitous.ubiquitos.uos.driverManager.UosDriver#destroy()
	 */
	@Override
	public void destroy() {}
