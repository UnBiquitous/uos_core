...
public class MessageHandlerTest {
	...
	public void setUp() throws Exception {
		...
		when(controlCenter.sendControlMessage(anyString(), anyBoolean(), anyString(), anyString()))
				.thenCallRealMethod();
		...
		ResourceBundle bundle = new ListResourceBundle() {
			protected Object[][] getContents() {
				return new Object[][] { { "ubiquitos.message.response.timeout", "1" },
	...
	public void callService_ShouldRejectANullCall() throws Exception {
		handler.callService(mock(UpDevice.class), null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectANullDevice() throws Exception {
		handler.callService(null, new Call("d", "s"));
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectNullDriverAndServiceOnCall() throws Exception {
		handler.callService(mock(UpDevice.class), new Call());
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectNullDriverOnCall() throws Exception {
		handler.callService(mock(UpDevice.class), new Call(null, "s"));
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectNullServiceOnCall() throws Exception {
		handler.callService(mock(UpDevice.class), new Call("d", null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectEmptyDriverAndServiceOnCall() throws Exception {
		handler.callService(mock(UpDevice.class), new Call("", ""));
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectEmptyDriverOnCall() throws Exception {
		handler.callService(mock(UpDevice.class), new Call("", "s"));
	}

	@Test(expected = IllegalArgumentException.class)
	public void callService_ShouldRejectEmptyServiceOnCall() throws Exception {
	...
	private class SnapshotScenario {
		...
		SnapshotScenario() throws Exception {
			...
			// Prepare Streams so we could capture what is going to the
			// networklayer
			...
			when(controlCenter.openActiveConnection(wifi.getNetworkAddress(), wifi.getNetType())).thenReturn(conn);
		}
	...
	@Test
	public void callService_aSimpleCallMustBeSentAndItsResponseRetrieved() throws Exception {
		...
		assertEquals("Should return the same response that was stimulated.", "NotAvailable",
				response.getResponseData("pic"));
		assertThat(mapper.readValue(scenario.grabSentString(), Call.class)).isEqualTo(scenario.snapshot);
	}

	@Test
	public void callService_aSimpleCallMustBeSentButWhenNoResponseIsRetrievedNullShouldBeReturned() throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
	...
	@Test
	public void callService_aSimpleCallMustBeSentButWhenNoConnectionIsPossibleNullShouldBeReturned() throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
		when(controlCenter.openActiveConnection(scenario.wifi.getNetworkAddress(), scenario.wifi.getNetType()))
				.thenReturn(null);
	...
	@Test
	public void callService_aSimpleCallMustBeSentButWhenNoValidConnectionIsReturnedNullShouldBeReturned()
			throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
	...
	@Test
	public void callService_ACallWithSecurityTypeMustResultOnAnEncapsulatedMessage() throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
		...
		when(translator.encode(any(String.class), eq(scenario.target.getName()))).thenReturn("Encoded Output Message");
		...
		Capsule sentMessage = mapper.readValue(scenario.grabSentString(), Capsule.class);
	...
	@Test(expected = MessageEngineException.class)
	public void callService_ACallWithProblemsThrowsAnException() throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
	...
	@Test(expected = MessageEngineException.class)
	public void callService_ACallWithSecurityTypeFailsWihtoutProperAuthenticator() throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
		scenario.snapshot.setSecurityType("Pig-Latin");
	...
	@Test(expected = MessageEngineException.class)
	public void callService_ACallWithSecurityTypeFailsWihtoutProperTranslator() throws Exception {
		SnapshotScenario scenario = new SnapshotScenario();
		scenario.snapshot.setSecurityType("Pig-Latin");
	...
	// Negative cases
	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectANullEvent() throws Exception {
		handler.notifyEvent(null, mock(UpDevice.class));
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectANullDevice() throws Exception {
		handler.notifyEvent(new Notify("d", "s"), null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectNullDriverAndKeyOnEvent() throws Exception {
		handler.notifyEvent(new Notify(), mock(UpDevice.class));
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectNullDriverOnEvent() throws Exception {
		handler.notifyEvent(new Notify(null, "s"), mock(UpDevice.class));
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectNullKeyOnEvent() throws Exception {
		handler.notifyEvent(new Notify("d", null), mock(UpDevice.class));
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectEmptyDriverAndKeyOnEvent() throws Exception {
		handler.notifyEvent(new Notify("", ""), mock(UpDevice.class));
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEventShouldRejectEmptyDriverOnEvent() throws Exception {
		handler.notifyEvent(new Notify("", "s"), mock(UpDevice.class));
	}

	@Test(expected = IllegalArgumentException.class)
	public void notifyEvent_ShouldRejectEmptyKeyOnEvent() throws Exception {
	...
	@Test
	public void notifyEvent_shouldSendForASimpleEvent() throws Exception {
		UserEnteredScenario scenario = new UserEnteredScenario();

		handler.notifyEvent(scenario.userEntered, scenario.target);

		assertEquals("The JSON sent should be compatible with the snapshot created.", scenario.userEntered,
				mapper.readValue(scenario.grabSentString(), Notify.class));

	}

	@Test(expected = MessageEngineException.class)
	public void notifyEvent_ACallWithProblemsThrowsAnException() throws Exception {
		UserEnteredScenario scenario = new UserEnteredScenario();
	...
	// TODO: Do Events have the capability to use security channels? If so
	// create tests based on callService
