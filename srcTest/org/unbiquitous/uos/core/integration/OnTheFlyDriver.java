...
public class OnTheFlyDriver implements UosEventDriver {
	...
	static public OnTheFlyDriver instance;

	private static final UpDriver driver = new UpDriver("br.unbiquitous.OnTheFly");
	{
